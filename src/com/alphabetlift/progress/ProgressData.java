...
public class ProgressData {
	...
	private static final String HELP_USED = "Help_used";
	...
	public void setHelpUsed(int blockNumber) {
		...
		int helpUsed = preferences.getInt(HELP_USED, 0);
		editor.putInt(HELP_USED, ++helpUsed);
	...
	public int getTotalHelpUsed() {
		return preferences.getInt(HELP_USED, 0);
	}
	...
	public boolean hasLicense() {
		return preferences.getBoolean(HAS_LICENSE, false);
	}
	
	public void setHasLicense() {
		editor.putBoolean(HAS_LICENSE, true);
		editor.commit();
	}
	
	public void clearData() {
		boolean hadLicense = hasLicense();
		editor.clear();
		editor.commit();
		if(hadLicense)
			setHasLicense();
	...
	public boolean isGameFinished() {
		return preferences.getBoolean(GAME_FINISHED, false);
	}
